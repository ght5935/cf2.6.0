...
class IndexPage extends React.Component {
  ...
  handleChange1 = info => {
    ...
    if (info.file.status === 'done') {
      ...
      this.onSelectImg(dst[0].path, dst[0].url, 1)
  ...
  handleChange2 = info => {
    ...
    if (info.file.status === 'done') {
      ...
      this.onSelectImg(dst[0].path, dst[0].url, 2)
  ...
  onSelectImg = (path, src, i) => {
    const match2ImageParams = this.props.contrast.match2ImageParams;
    if (i === 1) {
      this.setState({
  ...
  onContrast = () => {
    ...
    this.props.dispatch({
      type: 'contrast/matchTwoImages'
    });
  };


  render() {
    console.log(this.state.upload_1);
    return (
            ...
            <div className={styles.uploadWrapper}>
              ...
              <div className={styles.imgList}>
                {/* <img
                  ...
                  alt=""
                /> */}
                {this.state.imgList_1.map(v => (
                  <img
                    src={v.url}
                    onClick={this.onSelectImg.bind(this, v.path, v.url, 1)}
                    className={this.imgItemCss1(v.path)} alt=""
                  />
                                    ))}
              </div>
            </div>
              ...
              <div className={styles.magWrapper} id="mag">
                {this.state.magnifier ? '' : <div className={styles.Progress}>
                  <Progress
                    ...
                    type="circle"
                    percent={(this.props.contrast.percent * 100).toFixed(2)}
                  ...
                  <Button
                   size="large"
                    type="primary"
                    loading={this.props.contrast.btnLoading}
            ...
            <div className={styles.uploadWrapper} >
              ...
              <div className={styles.imgList}>
                {/* <img
                  ...
                  alt=""
                /> */}
                {this.state.imgList_2.map(v => (
                  <img
                    src={v.url}
                    className={this.imgItemCss2(v.path)}
                    onClick={this.onSelectImg.bind(this, v.path, v.url, 2)}
                    alt=""
                  />
                                    ))}
              </div>
...
function mapStateToProps({ contrast }) {
  return { contrast };
}
